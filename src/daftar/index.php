...
<div class="container d-flex flex-column border border-2 justify-content-center align-items-center p-5">
        ...
        <form action="" method="post" class="d-flex flex-column gap-3 border border-2 p-4">
            ...
            <input type="text" name="username_register" id="username_register" required>
            ...
            <button type="submit" name="username-register" class=" outline-0 border-0 border p-2 m-auto rounded-4">Login</button>
