...
<div class="outer-data-container">
    <?php foreach($siswa as $value): ?>
        ...
        <div class="pagination d-flex justify-content-between ">
          ...
          <button><a href="http://yusuf.com/latihanphp1/pertemuan9/src/sidebar/ajax/data/index.php?halaman=<?= $halamanaktif - 1?>"><</a></button>
          <?php endif?>
          <!-- <div class="pagenum d-flex"> -->
            ...
            <a href="http://yusuf.com/latihanphp1/pertemuan9/src/sidebar/ajax/data/index.php?halaman=<?= $halamanaktif?>"><?=$halamanaktif ?></a>
            <a href="http://yusuf.com/latihanphp1/pertemuan9/src/sidebar/ajax/data/index.php?halaman=<?= $halamanaktif + 1?>"><?=$halamanaktif + 1?></a>
          <!-- </div> -->
