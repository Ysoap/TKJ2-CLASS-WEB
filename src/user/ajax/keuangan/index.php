...
<div class="main border border-1 border-dark" id="history">
  ...
  <div class="data-history m-2 d-flex flex-column gap-2 bg-white">
    <?php foreach($passed_db as $key) : ?>
      <?php if($key['value'] != '0'):?>
        <div class="accordion m-0 accordion-flush border-0 border ps-2 pe-2 " id="accordionExample">
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button justify-content-between rounded rounded-2" type="button" data-bs-toggle="collapse" data-bs-target="#<?= $key['id']?>" aria-expanded="true" aria-controls="collapseOne">
